    ...
    <>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center py-32 px-4 sm:px-6 lg:px-8" id="hero" aria-labelledby="scale-hero-title">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
            <Link to="/apply" className="inline-flex items-center justify-center px-6 py-3 rounded-lg text-sm font-medium bg-white text-zinc-950 hover:bg-zinc-200 transition-colors bg-primary border-primary text-white shadow-lg shadow-primary/25 hover:bg-primary-dark">
      ...
      <section className="py-24 relative" aria-labelledby="problem-title">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-white/5 bg-zinc-900/50 p-8 md:p-12 border-l-4 border-l-primary">
            ...
            <h3 className="text-2xl md:text-4xl font-bold text-white mb-6">Scaling is Tough When the Fundamentals Are Fractured</h3>
      ...
      <section className="py-24 bg-zinc-900/30 border-y border-white/5" id="expected-results" aria-labelledby="expected-results-title">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <h3 className="text-3xl font-bold text-white">Clarity on the upside before we start</h3>
            ...
            <ul className="space-y-6 mt-6">
              <li>
                <strong className="block text-white text-lg">30–50 Qualified Leads</strong>
                <span className="text-zinc-500">Typical volume we unlock in the first 90 days with the right offer + funnels.</span>
              </li>
              <li>
                <strong className="block text-white text-lg">20–40% CPL Reduction</strong>
                <span className="text-zinc-500">Comes from fixing tracking, rebuilding creative, and tightening audience signals.</span>
              </li>
            </ul>
          </div>

          {/* Mini Case Card */}
          <div className="rounded-2xl border border-white/10 bg-zinc-900/80 p-8 shadow-2xl relative overflow-hidden group hover:border-emerald-500/30 transition-colors">
      ...
      <section className="py-24 relative" aria-labelledby="framework-title">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl font-bold text-white">The Framework Behind Sustainable Growth</h3>
          </div>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex gap-6 p-6 rounded-xl border border-white/5 bg-zinc-900/30 hover:bg-zinc-900/50 transition-colors group">
      ...
      <section className="py-24 bg-zinc-900/30 border-y border-white/5" id="how-it-works" aria-labelledby="how-it-works-title">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl font-bold text-white">A clear, accountable path from audit to scale</h3>
          </div>
      ...
      <section className="py-24 relative" id="case-studies" aria-labelledby="case-title">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl font-bold text-white">Proof the System Works</h3>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl border border-white/5 bg-zinc-900/50 hover:border-emerald-500/20 transition-colors">
              <strong className="block text-4xl font-bold text-white mb-2">18.1% CTR</strong>
              <span className="text-zinc-400 leading-relaxed">Google Ads for regional water-slide rentals with full-funnel tracking cleanup.</span>
            </div>
            <div className="p-8 rounded-2xl border border-white/5 bg-zinc-900/50 hover:border-emerald-500/20 transition-colors">
              <strong className="block text-4xl font-bold text-white mb-2">15% Lift</strong>
              <span className="text-zinc-400 leading-relaxed">Traffic &amp; conversions for dental and med-spa clients within 60 days.</span>
            </div>
            <div className="p-8 rounded-2xl border border-white/5 bg-zinc-900/50 hover:border-emerald-500/20 transition-colors">
              <strong className="block text-4xl font-bold text-white mb-2">37k Views</strong>
              <span className="text-zinc-400 leading-relaxed">A$1.08 CPC delivering 37k landing-page visits on A$2.3k ad spend.</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-zinc-900/30 border-y border-white/5" id="value-math" aria-labelledby="value-math-title">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 id="value-math-title" className="text-3xl md:text-4xl font-bold text-white mb-12 text-center">What Would 30 Qualified Opportunities in 90 Days Mean?</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-zinc-900/50 p-8 rounded-2xl border border-white/5">
              ...
              <ul className="space-y-3">
                {['More predictable pipeline and sales follow-up.', 'Cleaner reporting that connects spend to revenue.', 'Higher LTV thanks to better segmentation and nurture.'].map((item, i) => (
                  <li key={i} className="flex items-start gap-3 text-zinc-400">
            ...
            <div className="bg-gradient-to-br from-emerald-900/20 to-zinc-900/50 p-8 rounded-2xl border border-emerald-500/20">
      ...
      <section className="py-24 relative" aria-labelledby="services-title">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl font-bold text-white">What's Included When We Partner</h3>
          </div>
          ...
          <ul className="grid md:grid-cols-2 gap-4">
            {[
              ...
              <li key={i} className={`p-6 rounded-xl border border-white/5 bg-zinc-900/30 flex items-start gap-3 ${i === 4 ? 'md:col-span-2' : ''}`}>
      ...
      <section className="py-24 bg-zinc-900/30 border-y border-white/5" aria-labelledby="fit-clients-title">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl font-bold text-white">Designed for Ambitious Founders &amp; Marketing Leads</h3>
          </div>
      ...
      <section className="py-24 relative" id="guarantee" aria-labelledby="guarantee-title">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-b from-zinc-800 to-zinc-900 rounded-3xl p-1 border border-white/10 shadow-2xl">
            <div className="bg-zinc-950/80 backdrop-blur-sm rounded-[20px] p-8 md:p-12 text-center">
              <h2 id="guarantee-title" className="text-2xl md:text-3xl font-bold text-white mb-8">Simple, No-Fluff Guarantee</h2>
      ...
      <section className="py-32 relative overflow-hidden" aria-labelledby="cta-title">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-zinc-400 mb-10 max-w-2xl mx-auto">
            Let's build the roadmap that turns your ad spend into compounding revenue.
          </p>
          ...
          <p className="mt-6 text-sm text-zinc-500">
            Most calls end with a clear 90-day plan, even if we don't work together.
          </p>
        </div>
      </section>
    </>
