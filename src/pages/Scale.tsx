...
const SCALE_CONTENT = {
  hero: {
    ...
    badge: (
      <>
        Best for <strong className="text-zinc-700 dark:text-zinc-200">founders doing $10k–$100k/mo</strong> who want paid ads to become
    ...
    <>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center py-32 px-4 sm:px-6 lg:px-8" id="hero" aria-labelledby="scale-hero-title">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
          <h1 id="scale-hero-title" className="text-4xl sm:text-5xl lg:text-7xl font-bold tracking-tight text-zinc-900 dark:text-white leading-[1.1]">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
            <Link to="/apply" className="inline-flex items-center justify-center px-6 py-3 rounded-lg text-sm font-medium bg-primary text-primary-foreground hover:bg-primary/90 transition-colors shadow-md">
              Apply for Strategy Call
            </Link>
            <a href="#case-studies" className="inline-flex items-center justify-center px-6 py-3 rounded-lg text-sm font-medium border border-zinc-300 dark:border-white/10 bg-zinc-100 dark:bg-white/5 text-zinc-900 dark:text-white hover:bg-zinc-200 dark:hover:bg-white/10 transition-colors backdrop-blur-sm">
              View Case Studies
            </a>
          </div>

          <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-zinc-200 dark:border-white/10 bg-zinc-50 dark:bg-white/5 backdrop-blur-sm mt-8">
      ...
      {/* TRUST STRIP */}
      <section className="py-8 border-y border-zinc-200 dark:border-white/5 bg-zinc-50 dark:bg-zinc-900/50 backdrop-blur-sm" aria-label="Platform certifications">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ul className="flex flex-wrap justify-center gap-4 list-none p-0 m-0">
            {['Meta Partner', 'Google Ads Certified', 'HubSpot Solutions', 'Shopify Plus'].map((cert) => (
              <li key={cert} className="px-6 py-3 rounded-full bg-zinc-100 dark:bg-zinc-900/50 border border-zinc-200 dark:border-white/10 text-sm font-semibold text-zinc-600 dark:text-zinc-400">
                {cert}
              </li>
            ))}
          </ul>
      ...
      <section className="py-24 relative" aria-labelledby="problem-title">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-zinc-200 dark:border-white/5 bg-white dark:bg-zinc-900/50 backdrop-blur-md p-8 md:p-12 border-l-4 border-l-emerald-500 shadow-sm dark:shadow-none">
            ...
            <h3 className="text-2xl md:text-4xl font-bold text-zinc-900 dark:text-white mb-6">{SCALE_CONTENT.problem.title}</h3>
      ...
      {/* EXPECTED RESULTS */}
      <section className="py-24 bg-zinc-50/50 dark:bg-zinc-900/30 border-y border-zinc-200 dark:border-white/5" id="expected-results" aria-labelledby="expected-results-title">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <h3 className="text-3xl font-bold text-zinc-900 dark:text-white">{SCALE_CONTENT.results.title}</h3>
            ...
            <ul className="space-y-6 mt-6">
              {SCALE_CONTENT.results.items.map((item, i) => (
                <li key={i}>
                  <strong className="block text-zinc-900 dark:text-white text-lg">{item.label}</strong>
          ...
          {/* Mini Case Card */}
          <div className="rounded-2xl border border-zinc-200 dark:border-white/10 bg-white dark:bg-zinc-900/80 backdrop-blur-md p-8 shadow-2xl relative overflow-hidden group hover:border-emerald-500/30 transition-colors">
            <div className="absolute top-0 left-0 w-1 h-full bg-emerald-500" />
            <div className="absolute -inset-1 bg-emerald-500/5 blur opacity-0 group-hover:opacity-100 transition-opacity" />

            <span className="text-xs uppercase tracking-widest text-zinc-400 dark:text-zinc-500 font-bold mb-4 block">Med-Spa Lead Gen</span>
            <h4 className="text-xl font-bold text-zinc-900 dark:text-white mb-8">Booked Appointments</h4>

            <div className="mt-auto">
              <span className="text-4xl font-extrabold text-emerald-500 block mb-2">$22 CPL</span>
              <p className="text-sm text-zinc-500 dark:text-zinc-500 m-0">
      ...
      <section className="py-24 relative" aria-labelledby="framework-title">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl font-bold text-zinc-900 dark:text-white">{SCALE_CONTENT.framework.title}</h3>
          </div>

          <div className="space-y-4">
            {SCALE_CONTENT.framework.steps.map((step, i) => (
              <div key={i} className="flex gap-6 p-6 rounded-xl border border-zinc-200 dark:border-white/5 bg-white dark:bg-zinc-900/30 backdrop-blur-sm hover:bg-zinc-50 dark:hover:bg-zinc-900/50 transition-colors group shadow-sm dark:shadow-none">
                ...
                <div>
                  <strong className="block text-zinc-900 dark:text-white text-lg mb-1">{step.title}</strong>
                  <p className="text-zinc-600 dark:text-zinc-400 m-0">{step.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* HOW IT WORKS */}
      <section className="py-24 bg-zinc-50/50 dark:bg-zinc-900/30 border-y border-zinc-200 dark:border-white/5" id="how-it-works" aria-labelledby="how-it-works-title">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl font-bold text-zinc-900 dark:text-white">{SCALE_CONTENT.howItWorks.title}</h3>
          </div>

          <div className="relative">
            <div className="absolute left-[19px] top-6 bottom-6 w-0.5 bg-zinc-200 dark:bg-white/10" />
            <div className="space-y-12">
              {SCALE_CONTENT.howItWorks.steps.map((step, i) => (
                <div key={i} className="relative pl-16">
                  <div className="absolute left-0 top-1 w-10 h-10 rounded-full bg-white dark:bg-zinc-900 border border-emerald-500/30 text-emerald-500 flex items-center justify-center font-bold z-10 shadow-[0_0_15px_rgba(16,185,129,0.2)]">
                    {i + 1}
                  </div>
                  <h4 className="text-xl font-bold text-zinc-900 dark:text-white mb-2">{step.title}</h4>
                  <p className="text-zinc-600 dark:text-zinc-400 text-lg">{step.desc}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-24 relative" id="case-studies" aria-labelledby="case-title">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl font-bold text-zinc-900 dark:text-white">{SCALE_CONTENT.caseStudies.title}</h3>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {SCALE_CONTENT.caseStudies.items.map((study, i) => (
              <div key={i} className="p-8 rounded-2xl border border-zinc-200 dark:border-white/5 bg-white dark:bg-zinc-900/50 backdrop-blur-md hover:border-emerald-500/20 transition-colors shadow-sm dark:shadow-none">
                <strong className="block text-4xl font-bold text-zinc-900 dark:text-white mb-2">{study.stat}</strong>
                <span className="text-zinc-600 dark:text-zinc-400 leading-relaxed">{study.desc}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* VALUE MATH */}
      <section className="py-24 bg-zinc-50/50 dark:bg-zinc-900/30 border-y border-zinc-200 dark:border-white/5" id="value-math" aria-labelledby="value-math-title">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 id="value-math-title" className="text-3xl md:text-4xl font-bold text-zinc-900 dark:text-white mb-12 text-center">{SCALE_CONTENT.valueMath.title}</h2>

          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-white dark:bg-zinc-900/50 backdrop-blur-md p-8 rounded-2xl border border-zinc-200 dark:border-white/5 shadow-sm dark:shadow-none">
              <h3 className="text-xl font-bold text-zinc-900 dark:text-white mb-4">More than just cheaper leads</h3>
            ...
            <div className="bg-gradient-to-br from-emerald-50 dark:from-emerald-900/20 to-white dark:to-zinc-900/50 backdrop-blur-md p-8 rounded-2xl border border-emerald-500/20 shadow-sm dark:shadow-none">
              <h3 className="text-xl font-bold text-zinc-900 dark:text-white mb-4">Simple revenue math</h3>
      ...
      <section className="py-24 relative" aria-labelledby="services-title">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl font-bold text-zinc-900 dark:text-white">{SCALE_CONTENT.services.title}</h3>
          </div>

          <ul className="grid md:grid-cols-2 gap-4">
            {SCALE_CONTENT.services.items.map((item, i) => (
              <li key={i} className={`p-6 rounded-xl border border-zinc-200 dark:border-white/5 bg-white dark:bg-zinc-900/30 backdrop-blur-sm flex items-start gap-3 shadow-sm dark:shadow-none ${i === 4 ? 'md:col-span-2' : ''}`}>
      ...
      {/* WHO YOU WORK WITH */}
      <section className="py-24 bg-zinc-50/50 dark:bg-zinc-900/30 border-y border-zinc-200 dark:border-white/5" aria-labelledby="fit-clients-title">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl font-bold text-zinc-900 dark:text-white">{SCALE_CONTENT.partners.title}</h3>
          </div>

          <div className="grid md:grid-cols-2 gap-6">
            {SCALE_CONTENT.partners.items.map((item, i) => (
              <div key={i} className="flex gap-4 items-start">
                <div className="w-12 h-12 rounded-full bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-white/10 flex items-center justify-center text-zinc-900 dark:text-white font-bold shrink-0">
                  {i + 1}
                </div>
                <p className="text-zinc-600 dark:text-zinc-400 text-lg m-0 pt-2">{item}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 relative" id="guarantee" aria-labelledby="guarantee-title">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-b from-zinc-100 dark:from-zinc-800 to-zinc-200 dark:to-zinc-900 rounded-3xl p-1 border border-zinc-300 dark:border-white/10 shadow-2xl">
            <div className="bg-white dark:bg-zinc-950/80 backdrop-blur-md rounded-[20px] p-8 md:p-12 text-center">
              <h2 id="guarantee-title" className="text-2xl md:text-3xl font-bold text-zinc-900 dark:text-white mb-8">{SCALE_CONTENT.guarantee.title}</h2>
      ...
      <section className="py-32 relative overflow-hidden" aria-labelledby="cta-title">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-white dark:from-zinc-950 to-transparent pointer-events-none" />

        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 id="cta-title" className="text-4xl md:text-6xl font-bold text-zinc-900 dark:text-white tracking-tight mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link to="/apply" className="inline-flex items-center justify-center px-8 py-4 rounded-full text-lg font-bold bg-zinc-900 dark:bg-white text-white dark:text-zinc-950 hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-all shadow-[0_0_40px_rgba(0,0,0,0.15)] dark:shadow-[0_0_40px_rgba(255,255,255,0.3)] hover:shadow-[0_0_60px_rgba(0,0,0,0.25)] dark:hover:shadow-[0_0_60px_rgba(255,255,255,0.5)] transform hover:-translate-y-1">
