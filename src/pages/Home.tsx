...
export const Home = () => {
  ...
  return (
    <>
      ...
      {/* Logo Bar - Infinite Marquee UX Polish */}
      <section className="py-12 border-y border-zinc-200 dark:border-white/5 bg-white/50 dark:bg-zinc-900/50 backdrop-blur-sm relative overflow-hidden" aria-label="Client logos">
        ...
        <div className="max-w-[100vw] mx-auto">
          <div className="text-center mb-10">
            <p className="text-xs font-bold text-zinc-500 uppercase tracking-widest pl-4">
              Brands &amp; Operators I’ve Helped
            </p>
          </div>

          <div className="flex w-fit animate-marquee [--duration:40s] hover:[animation-play-state:paused]">
            <div className="flex items-center gap-16 px-8 opacity-75 dark:opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
              <img src="/img/clients/new-logo-1.png" alt="Wedding Realm" className="h-10 md:h-12 w-auto brightness-0 dark:brightness-0 dark:invert transition-all" loading="lazy" />
              <img src="/img/clients/new-logo-2.png" alt="Dignity Memorial" className="h-8 md:h-10 w-auto brightness-0 dark:brightness-0 dark:invert transition-all" loading="lazy" />
              <img src="/img/clients/new-logo-5.png" alt="FPL" className="h-10 md:h-12 w-auto brightness-0 dark:brightness-0 dark:invert transition-all" loading="lazy" />
              <img src="/img/clients/new-logo-4.png" alt="Real Estate" className="h-10 md:h-12 w-auto brightness-0 dark:brightness-0 dark:invert transition-all" loading="lazy" />
              <img src="/img/clients/new-logo-3.png" alt="Client Partner" className="h-8 md:h-10 w-auto brightness-0 dark:brightness-0 dark:invert transition-all" loading="lazy" />
            </div>
            {/* Duplicated for seamless scrolling */}
            <div className="flex items-center gap-16 px-8 opacity-75 dark:opacity-50 grayscale hover:grayscale-0 transition-all duration-500" aria-hidden="true">
              <img src="/img/clients/new-logo-1.png" alt="Wedding Realm" className="h-10 md:h-12 w-auto brightness-0 dark:brightness-0 dark:invert transition-all" loading="lazy" />
              <img src="/img/clients/new-logo-2.png" alt="Dignity Memorial" className="h-8 md:h-10 w-auto brightness-0 dark:brightness-0 dark:invert transition-all" loading="lazy" />
              <img src="/img/clients/new-logo-5.png" alt="FPL" className="h-10 md:h-12 w-auto brightness-0 dark:brightness-0 dark:invert transition-all" loading="lazy" />
              <img src="/img/clients/new-logo-4.png" alt="Real Estate" className="h-10 md:h-12 w-auto brightness-0 dark:brightness-0 dark:invert transition-all" loading="lazy" />
      ...
      <section className="py-24 relative" id="services">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {/* Service 1 */}
            <motion.div variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { duration: 0.6, ease: "easeOut" } } }} className="group relative rounded-2xl border border-zinc-200 dark:border-white/10 bg-white/80 dark:bg-zinc-900/70 backdrop-blur-md p-8 transition-all duration-300 hover:bg-zinc-50 dark:hover:bg-zinc-800/90 hover:border-emerald-500/30 hover:shadow-2xl hover:shadow-emerald-500/10 dark:hover:shadow-emerald-500/10">
      ...
      <section className="py-24 bg-zinc-50/50 dark:bg-zinc-900/30 border-y border-zinc-200 dark:border-white/5" id="skills" aria-labelledby="skills-title">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {/* ... Bento Items ... */}
            <motion.div variants={{ hidden: { opacity: 0, scale: 0.95 }, visible: { opacity: 1, scale: 1, transition: { duration: 0.5 } } }} className="md:col-span-2 rounded-2xl border border-zinc-200 dark:border-white/10 bg-white dark:bg-zinc-900/70 backdrop-blur-md p-8 flex flex-col justify-between hover:border-zinc-300 dark:hover:border-white/20 transition-colors shadow-sm dark:shadow-none">
              <div>
            ...
            <motion.div variants={{ hidden: { opacity: 0, scale: 0.95 }, visible: { opacity: 1, scale: 1, transition: { duration: 0.5 } } }} className="rounded-2xl border border-zinc-200 dark:border-white/5 bg-white dark:bg-zinc-900/50 backdrop-blur-md p-8 flex flex-col justify-center hover:border-zinc-300 dark:hover:border-white/10 transition-colors shadow-sm dark:shadow-none">
            ...
            <motion.div variants={{ hidden: { opacity: 0, scale: 0.95 }, visible: { opacity: 1, scale: 1, transition: { duration: 0.5 } } }} className="rounded-2xl border border-zinc-200 dark:border-white/5 bg-white dark:bg-zinc-900/50 backdrop-blur-md p-8 hover:border-zinc-300 dark:hover:border-white/10 transition-colors shadow-sm dark:shadow-none">
            ...
            <motion.div variants={{ hidden: { opacity: 0, scale: 0.95 }, visible: { opacity: 1, scale: 1, transition: { duration: 0.5 } } }} className="md:col-span-2 rounded-2xl border border-zinc-200 dark:border-white/5 bg-white dark:bg-zinc-900/50 backdrop-blur-md p-8 hover:border-zinc-300 dark:hover:border-white/10 transition-colors shadow-sm dark:shadow-none">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center overflow-hidden">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-8">
                <div className="p-6 rounded-xl bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/5 backdrop-blur-sm shadow-sm dark:shadow-none hover:border-emerald-500/30 transition-colors">
                ...
                <div className="p-6 rounded-xl bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/5 backdrop-blur-sm shadow-sm dark:shadow-none hover:border-blue-500/30 transition-colors">
            ...
            >
              <div className="aspect-video bg-gradient-to-br from-zinc-100 to-zinc-200 dark:from-zinc-800 dark:to-zinc-900 rounded-2xl border border-zinc-200 dark:border-white/10 flex items-center justify-center overflow-hidden group">
                <div className="absolute inset-0 bg-primary/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                <div className="text-zinc-400 dark:text-zinc-500 font-mono text-sm group-hover:scale-105 transition-transform duration-500">RR Labs Team</div>
              </div>
            </motion.div>
          </div>
        </div>
