...
// Since the content is pre-parsed by the vite plugin or gray-matter, we just render it.
            ...
            <div className="container mx-auto px-4 max-w-4xl">
                ...
                >
                    ...
                    <article className="prose prose-invert prose-lg max-w-none prose-headings:font-bold prose-a:text-blue-400">
                        {/* 
                            This is simplified rendering. With 'react-markdown', you would do:
                            <ReactMarkdown>{caseStudy.markdownContent}</ReactMarkdown> 
                        */}
