...
- [x] **Visuals:** The existing `Wizard.tsx` container uses `backdrop-blur-xl`, thin borders (`border-white/10`), and deep zinc background.
- [x] **Progress:** A clear visual step indicator ("Step 1 of 4") is visible at all times.
- [x] **Inputs:** Form fields use the "Modern Agency" styling (transparent bg, bottom border or floating label).
- [x] **Responsiveness:** Fully usable on mobile devices.
